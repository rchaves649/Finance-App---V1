        ...
        <table className="w-full text-left">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-100">
              ...
              {isShared && (
                <>
                  <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Valor A</th>
                  <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Valor B</th>
                </>
              )}
              <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase">Categoria</th>
              <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase">Subcategoria</th>
